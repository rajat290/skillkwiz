      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-16 relative h-[450px] md:h-[400px]">
          ...
          >
            ...
            <p className="text-gray-700 text-center text-sm">
              Our huge skill library of over 3000 skills means you can choose a
              wide variety of skill sets against which to measure candidates.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 text-black max-w-xs w-full md:w-64 md:h-[350px] transform md:z-20 hover:-translate-y-2 transition-transform duration-300 shadow-lg md:absolute md:left-[calc(50%-130px)]">
            ...
            <p className="text-gray-700 text-center text-sm">
              ...
              Candidates are authenticated with government-approved
              identification before their test reports are shared.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-700 text-center text-sm">
              We provide flexible pricing options. Pay per report, or save with
              subscription plans that offer unlimited reports.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-32 md:mt-24 relative z-20">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-sm">
            ...
            selection a breeze with our tried and tested platform.
          </p>
          <Link
            href="/services"
