        ...
        <div className="max-w-7xl mx-auto px-6">
              ...
              {blogPosts.map((post, index) => (
                ...
                >
                  ...
                  <a
                    ...
                    className="mt-3 text-sm font-semibold text-[#00418d] hover:underline"
                  >
                    Download Article
                  </a>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            >
              ...
              <a
                ...
                download
                onClick={(event) => event.stopPropagation()}
                className="text-sm font-semibold text-[#00418d] hover:underline"
              >
                Download Article
              </a>
            </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4 mb-6 cursor-pointer" onClick={() => setShowThankYou(true)}>
